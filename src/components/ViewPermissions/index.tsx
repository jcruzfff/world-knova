...
export const ViewPermissions = () => {
  ...
  useEffect(() => {
    const fetchPermissions = async () => {
      // Double check: both useMiniKit says it's installed AND MiniKit.isInstalled() returns true
      if (isInstalled && MiniKit.isInstalled()) {
        ...
        console.log('MiniKit is not fully installed or running in browser mode');
      }
    };
    fetchPermissions();
  }, [isInstalled]);
